const EntityModel = require('../modelos/Estilo');
...
async function create(req, res) {
    ...
    const newObject = new EntityModel({
        ...
        header: body.header,
        botonCrear: body.botonCrear,
        botonGuardar: body.botonGuardar,
        botonAcciones: body.botonAcciones,
        botonAgregar: body.botonAgregar,
        tituloDetalle: body.tituloDetalle,
        paginador: body.paginador,
        dasboard: body.dasboard,
        logoCompania: body.logoCompania,
