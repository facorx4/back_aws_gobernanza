const EntityModel = require('../modelos/RepositorioTablaCampo');
...
async function create(req, res) {
    ...
    const newObject = new EntityModel({
        ...
        LlavePrimaria: body.LlavePrimaria,
        PermiteNulos: body.PermiteNulos,
        repositorioTabla: body.repositorioTabla,
    });
